...
export default function DashboardLayout({
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      if (mobile) {
        ...
        setIsSidebarOpen(true);  // Keep open on desktop load
      }
    };
  ...
  // Close sidebar drawer on mobile navigation change
  useEffect(() => {
    if (isMobile) {
  ...
  return (
    <ProtectedRoute>
      <div className="dashboard-container" style={{ display: 'flex', minHeight: '100vh', background: '#f8fafc' }}>
        ...
        {isMobile && (
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <span style={{ fontSize: '14px', fontWeight: 700, color: '#002d9c', letterSpacing: '-0.01em' }}>Placement AI</span>
            </div>
            <div style={{ width: '32px' }} /> {/* Spacing anchor */}
          </div>
        )}
        ...
        {/* Backdrop Overlay on Mobile when Sidebar drawer is open */}
